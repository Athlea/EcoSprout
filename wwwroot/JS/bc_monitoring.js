...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const autoWaterRef = {
        ...
        moistureThreshold: ref(database, "settings/autoWater/pump1/moistureThreshold"),
        temperatureThreshold: ref(database, "settings/autoWater/pump1/temperatureThreshold")
    };
    ...
    const waterNowRef = {
        ...
        status: ref(database, "settings/manualWater/pump1/status"),
